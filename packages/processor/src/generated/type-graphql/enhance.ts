...
const crudResolversInfo = {
  Block: ["aggregateBlock", "createManyBlock", "createOneBlock", "deleteManyBlock", "deleteOneBlock", "findFirstBlock", "findFirstBlockOrThrow", "blocks", "block", "getBlock", "groupByBlock", "updateManyBlock", "updateOneBlock", "upsertOneBlock"],
  Balance: ["aggregateBalance", "createManyBalance", "createOneBalance", "deleteManyBalance", "deleteOneBalance", "findFirstBalance", "findFirstBalanceOrThrow", "balances", "balance", "getBalance", "groupByBalance", "updateManyBalance", "updateOneBalance", "upsertOneBalance"]
};
const argsInfo = {
...
const modelsInfo = {
  Block: ["height", "createdAt"],
  Balance: ["height", "address", "balance"]
};
...
const outputsInfo = {
  ...
  BlockGroupBy: ["height", "createdAt", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateBalance: ["_count", "_avg", "_sum", "_min", "_max"],
  BalanceGroupBy: ["height", "address", "balance", "_count", "_avg", "_sum", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  BlockCountAggregate: ["height", "createdAt", "_all"],
  BlockAvgAggregate: ["height"],
  BlockSumAggregate: ["height"],
  BlockMinAggregate: ["height", "createdAt"],
  BlockMaxAggregate: ["height", "createdAt"],
  BalanceCountAggregate: ["height", "address", "balance", "_all"],
  BalanceAvgAggregate: ["height"],
  BalanceSumAggregate: ["height"],
  BalanceMinAggregate: ["height", "address", "balance"],
  BalanceMaxAggregate: ["height", "address", "balance"],
  CreateManyBlockAndReturnOutputType: ["height", "createdAt"],
  CreateManyBalanceAndReturnOutputType: ["height", "address", "balance"]
};
...
const inputsInfo = {
  BlockWhereInput: ["AND", "OR", "NOT", "height", "createdAt"],
  BlockOrderByWithRelationInput: ["height", "createdAt"],
  BlockWhereUniqueInput: ["height", "AND", "OR", "NOT", "createdAt"],
  BlockOrderByWithAggregationInput: ["height", "createdAt", "_count", "_avg", "_max", "_min", "_sum"],
  BlockScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "height", "createdAt"],
  BalanceWhereInput: ["AND", "OR", "NOT", "height", "address", "balance"],
  BalanceOrderByWithRelationInput: ["height", "address", "balance"],
  BalanceWhereUniqueInput: ["height", "AND", "OR", "NOT", "address", "balance"],
  BalanceOrderByWithAggregationInput: ["height", "address", "balance", "_count", "_avg", "_max", "_min", "_sum"],
  BalanceScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "height", "address", "balance"],
  BlockCreateInput: ["createdAt"],
  BlockUpdateInput: ["createdAt"],
  BlockCreateManyInput: ["height", "createdAt"],
  BlockUpdateManyMutationInput: ["createdAt"],
  BalanceCreateInput: ["address", "balance"],
  BalanceUpdateInput: ["address", "balance"],
  BalanceCreateManyInput: ["height", "address", "balance"],
  BalanceUpdateManyMutationInput: ["address", "balance"],
  IntFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not"],
  DateTimeFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not"],
  BlockCountOrderByAggregateInput: ["height", "createdAt"],
  BlockAvgOrderByAggregateInput: ["height"],
  BlockMaxOrderByAggregateInput: ["height", "createdAt"],
  BlockMinOrderByAggregateInput: ["height", "createdAt"],
  BlockSumOrderByAggregateInput: ["height"],
  IntWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not", "_count", "_avg", "_sum", "_min", "_max"],
  DateTimeWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not", "_count", "_min", "_max"],
  StringFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "contains", "startsWith", "endsWith", "mode", "not"],
  BalanceCountOrderByAggregateInput: ["height", "address", "balance"],
  BalanceAvgOrderByAggregateInput: ["height"],
  BalanceMaxOrderByAggregateInput: ["height", "address", "balance"],
  BalanceMinOrderByAggregateInput: ["height", "address", "balance"],
