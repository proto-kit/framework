...
export class BatchBlocksArgs {
  ...
  distinct?: Array<"hash" | "transactionsHash" | "beforeNetworkState" | "duringNetworkState" | "height" | "fromEternalTransactionsHash" | "toEternalTransactionsHash" | "fromBlockHashRoot" | "fromMessagesHash" | "toMessagesHash" | "parentHash" | "batchHeight"> | undefined;
}
