...
export class TransactionExecutionResultMapper
  implements ObjectMapper<TransactionExecutionResult, [Omit<DBTransactionExecutionResult, "blockHash">, DBTransaction]> {
  public constructor(private readonly transactionMapper: TransactionMapper, private readonly stArrayMapper: StateTransitionArrayMapper) {
  }

  public mapIn(input: [Omit<DBTransactionExecutionResult, "blockHash">, DBTransaction]): TransactionExecutionResult {
