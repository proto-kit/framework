...
export class GroupByBlockArgs {
  ...
  by!: Array<"hash" | "transactionsHash" | "beforeNetworkState" | "duringNetworkState" | "height" | "fromEternalTransactionsHash" | "toEternalTransactionsHash" | "fromBlockHashRoot" | "fromMessagesHash" | "toMessagesHash" | "parentHash" | "batchHeight">;
